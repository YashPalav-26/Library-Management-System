...
class GiveBook(Toplevel):
    def __init__(self):
        ...
        # Bottom Frame
        self.bottomFrame = Frame(self, height=600, bg='#46F49A')
        ...
        self.lbl_name = Label(self.bottomFrame, text='Book: ', font='arial 15 bold', fg='black', bg='#46F49A')
        ...
        self.lbl_phone = Label(self.bottomFrame, text='Member: ', font='arial 15 bold', fg='black', bg='#46F49A')
