...
class AddBook(Toplevel):
    def __init__(self):
        ...
        #Bottom Frame
        self.bottomFrame= Frame(self,height=600,bg='lightblue')
        ...
        #name
        self.lbl_name=Label(self.bottomFrame,text='Name :',font='arial 15 bold',fg='black',bg='lightblue')
        ...
        # author
        self.lbl_author = Label(self.bottomFrame, text='Author :', font='arial 15 bold', fg='black', bg='lightblue')
        ...
        self.ent_author.place(x=150, y=85)
         ...
         # page
        self.lbl_page = Label(self.bottomFrame, text='Page :', font='arial 15 bold', fg='black', bg='lightblue')
        ...
        # language
        self.lbl_language = Label(self.bottomFrame, text='Language :', font='arial 15 bold', fg='black', bg='lightblue')
        ...
        #Button
        self.button=Button(self.bottomFrame,text='Add Book',command=self.addBook)
        self.button.place(x=270,y=220)
